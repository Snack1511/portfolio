...
public class enemy_B : MonoBehaviour {
    public static new SpriteRenderer renderer_EB;
    public static uint count = 0;
    // Use this for initialization
    void Start()
    {
        renderer_EB = GetComponent<SpriteRenderer>();
        renderer_EB.material.SetColor("_Color", Color.blue);
    }
    ...
    void OnTriggerEnter2D(Collider2D col_color)
    {
        ...
        {
            if (player.renderer_P.material.GetColor("_Color") == renderer_EB.material.GetColor("_Color"))
            {
