...
public class RoundManager:MonoBehaviour
{
    ...
    public void SetRoundManager(SelectData[] Selected, GameObject Scoreboard, int n = 0)
    {
    ...
    public static GameObject InitRoundMgr(SelectData[] Selected, GameObject Scoreboard, int n = 0)
    {
        GameObject RoundMgrobj = GameObject.Find("RoundMgr");
        if (RoundMgrobj == null)
        {
            RoundMgrobj = new GameObject();
            RoundMgrobj.name = "RoundMgr";
            RoundMgrobj.AddComponent<RoundManager>();
            RoundMgrobj.GetComponent<RoundManager>().SetRoundManager(Selected, Scoreboard, n);
            DontDestroyOnLoad(RoundMgrobj);
        }
        return RoundMgrobj;
