...
public:
	...
	void WriteBuffer(int _ix, int _iy, char* string, int _setcolor);			// 버퍼 쓰기
	void WriteBuffer(int _ix, int _iy, int string, int _setcolor);
	void WriteBuffer(int _ix, int _iy, char* cstring, int string, char* _cstring, int _setcolor);
	void WriteBuffer(int _ix, int _iy, char* cstring, int istring, char* _cstring, int _istring, char* _cpstring, int _setcolor);
